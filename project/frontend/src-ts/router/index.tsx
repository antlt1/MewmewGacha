    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'login', element: <PlaceholderPage title="Login" subtitle="Dang nhap user (placeholder)" /> },
          { path: 'register', element: <PlaceholderPage title="Register" subtitle="Dang ky tai khoan (placeholder)" /> },
