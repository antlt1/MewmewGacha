    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-white/5 mt-auto flex flex-col gap-3">
          <button className="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg text-[#f5b041] hover:bg-[#f5b041]/10 transition-colors border border-[#f5b041]/20 font-medium text-sm">
            <Coffee size={16} />
            Buy me a coffee
          </button>

          <button className="flex items-center justify-center w-full py-2.5 rounded-lg border border-white/10 text-white hover:bg-white/5 transition-colors font-medium text-sm">
            Log In
          </button>
        </div>
      </aside>
